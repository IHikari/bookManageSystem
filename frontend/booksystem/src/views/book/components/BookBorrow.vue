...
import { bookGetDetailService, bookBorrowService } from '../../../api/book.js'
...
<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="借阅数量" prop="book_num">
        <el-input
      ...
      <el-form-item>
        <el-button @click="onBorrow()" type="primary">提交</el-button>
